...
namespace ADBC2
{
    ...
    {   
        ...
        public static void SetBold(this RichTextBox textbox, bool enable = true)
        {
            textbox.SelectionFont = new Font(DefaultFamily, DefaultSize, enable ? FontStyle.Bold : FontStyle.Regular);
        }
